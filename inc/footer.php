    ...
    <footer class="footer bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white">Copyright &copy; <?php echo date('Y'); ?> | Monday, Goodness |H/F2021/COM/001 | Design and Implementation of a Product Expiry Alert Management System | </p>
      </div>
    </footer>
