...
$message  = 'Hello '.$fullname.', Your Drug ('.$drug.') in your stock will soon expire. Available Quantity is '.$stock.'. Purchase New Drugs Now. Thanks';
	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  <a class="nav-link active" id="v-pills-item-tab" data-toggle="pill" href="#v-pills-item" role="tab" aria-controls="v-pills-item" aria-selected="true">Drugs</a>
			  ...
			  <a href="user/index.php">Update User Details</a></div>
		</div>
		 <div class="col-lg-10">
			<div class="tab-content" id="v-pills-tabContent">
			  <div class="tab-pane fade show active" id="v-pills-item" role="tabpanel" aria-labelledby="v-pills-item-tab">
				<div class="card card-outline-secondary my-4">
				  <div class="card-header">Drug Details</div>
				  <div class="card-body">
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemDetailsTab">Drug</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
							...
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemDetailsItemNumber">Drug Number<span class="requiredIcon">*</span></label>
							  ...
							  <div class="form-row">
								  <div class="form-group col-md-6">
									<label for="itemDetailsItemName">Drug Name<span class="requiredIcon">*</span></label>
							  ...
							  <button type="button" id="addItem" class="btn btn-success">Add Drug</button>
						...
						<div id="itemImageTab" class="container-fluid tab-pane fade">
							...
							<form name="imageForm" id="imageForm" method="post">
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemImageItemNumber">Drug Number<span class="requiredIcon">*</span></label>
								...
								<div class="form-group col-md-4">
									<label for="itemImageItemName">Drug Name</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="purchaseDetailsItemNumber">Drug Number<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-row"> 
						  <div class="form-group col-md-4">
							<label for="purchaseDetailsItemName">Drug Name<span class="requiredIcon">*</span></label>
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-4">
						  <label for="vendorDetailsVendorDistrict">State</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="saleDetailsItemNumber">Drug Number<span class="requiredIcon">*</span></label>
					  ...
					  <div class="form-row">
						  <div class="form-group col-md-5">
							<label for="saleDetailsItemName">Drug Name</label>
			  ...
			  <div class="tab-pane fade" id="v-pills-search" role="tabpanel" aria-labelledby="v-pills-search-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemSearchTab">Drug</a>
						</li>
						<li class="nav-item">
			  ...
			  <div class="tab-pane fade" id="v-pills-reports" role="tabpanel" aria-labelledby="v-pills-reports-tab">
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">										
					<ul class="nav nav-tabs" role="tablist">
						<li class="nav-item">
							<a class="nav-link active" data-toggle="tab" href="#itemReportsTab">Drug</a>
						</li>
						<li class="nav-item">
					...
					<div class="tab-content">
						<div id="itemReportsTab" class="container-fluid tab-pane active">
							<br>
							<p>Use the grid below to get reports for Drugs</p>
